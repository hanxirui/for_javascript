...
CREATE TABLE t_ml_back_plane (
  ...
  PRIMARY KEY (c_id)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT=' 背板管理表';
...
CREATE TABLE t_ml_manuf (
  ...
  PRIMARY KEY (c_id)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='厂商管理表';
...
CREATE TABLE t_ml_user (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='模型用户表';
